...
- Name: e2e\features\admin.feature.spec.js >> Admin: list, view, and delete users >> Admin can view a mentor's detail and delete them
- Location: e2e\.features-gen\e2e\features\admin.feature.spec.js:6:3
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    7 × locator resolved to <html lang="en" data-theme="light">…</html>
