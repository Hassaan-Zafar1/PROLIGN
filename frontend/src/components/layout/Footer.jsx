        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4 cursor-pointer" onClick={() => navigateTo('home')}>
              ...
              <span className="font-headline-md font-bold text-xl tracking-tight">MentorBridge</span>
            </div>
          ...
          <div>
            <h4 className="font-semibold mb-4 text-secondary-container">Resources</h4>
            <ul className="space-y-2 text-sm text-on-primary/80">
              <li><button onClick={() => navigateTo('resources')} className="hover:text-white transition-colors cursor-pointer text-left w-full">Career Blog</button></li>
              <li><button onClick={() => navigateTo('resources')} className="hover:text-white transition-colors cursor-pointer text-left w-full">Interview Prep</button></li>
              <li><button onClick={() => navigateTo('resources')} className="hover:text-white transition-colors cursor-pointer text-left w-full">Resume Templates</button></li>
